...
public class MineSweeper {
	...
	// provera da li su indeksi u legalnom opsegu (ne idu izvan matrice)	
	...
	private static int izracunaj(int[][] matrix, int i, int j) {
		// kako bismo izbegli more if-ova primetimo da se logika provere svodi na dodavanje fiksnih pomeraja, stoga sve pomeraje mozemo staviti u 2d niz i samo proci kroz sve elemente
